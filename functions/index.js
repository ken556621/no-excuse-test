...
exports.getGymDataFromLocal = functions.https.onRequest((req, res) => {
    const db = admin.firestore();
    const origin_URL = "https://iplay.sa.gov.tw/api/GymSearchAllList?$format=application/json;odata.metadata=none&City=臺北市&GymType=籃球場&Latitude=25.0424536&Longitude=121.562731"; 
